...
import { buttonPrimarySmallStyles, buttonDangerStyles, buttonSecondarySmallStyles } from '../../lib/styles';
...
// Small button styles
const buttonSuccessSmallStyles = 'inline-flex items-center justify-center font-medium rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 transition-colors px-3 py-1.5 text-xs text-white bg-green-600 hover:bg-green-700 focus:ring-green-500 dark:focus:ring-offset-gray-800';
const buttonDangerSmallStyles = 'inline-flex items-center justify-center font-medium rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 transition-colors px-3 py-1.5 text-xs text-white bg-red-600 hover:bg-red-700 focus:ring-red-500 dark:focus:ring-offset-gray-800';
