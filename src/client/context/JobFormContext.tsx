...
export const jobFormActions = {
  ...
  updateHealthCheck: (groupIndex: number, field: keyof NomadHealthCheck, value: string | number | boolean): JobFormAction => ({ type: 'UPDATE_HEALTH_CHECK', payload: { groupIndex, field, value } }),
